            ...
            <div class="container mx-auto">
                <div class="justify-between flex items-center py-2">
                    ...
                    <a class="navbar-brand" href="{{ url('/') }}">
                        ...
                        <svg xmlns="http://www.w3.org/2000/svg" width="291" height="45" viewBox="0 0 291 45" class="text-default relative">
                            <g fill="none" fill-rule="evenodd">
                                <g class="fill-current">
                                    <path
                                        ...
                                        <text font-family="Lato" font-size="12" transform="translate(51 14)">
                                ...
                                <dropdown align="right" width="100%">
                                    <template v-slot:trigger>
                                        <button class="flex items-center text-default no-underline text-sm focus:outline-none">
                                            <img width="35" src="{{ gravatar_url(auth()->user()->email) }}" alt=""
                                                class="rounded-full mr-3">
                                            {{ auth()->user()->name }}
                                        </button>
                                    </template>
                                    <!-- <a href="#" class="dropdown-menu-link" onclick="event.preventDefault();
